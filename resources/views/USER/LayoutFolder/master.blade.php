        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-dark bg-warning px-2">CODE LAB</span>
                    <span class="h1 text-uppercase text-warning bg-dark px-2 ml-n1">Shop</span>
                </a>
            </div>
        </div>
    </div> --}}
    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block pt-3">
                ...
                <a href="" class="text-decoration-none">
                    <span class="h3 text-uppercase text-warning py-5 px-2">My Shop</span>
                </a>
            </div>
            <div class="col-lg-9">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-inline me-5">
                                <a class="btn btn-secondary dropdown-toggle" href="#" role="button"
                                    ...
                                    @else
                                        <i class="fa-solid fa-person-dress"></i> {{ Auth::user()->name }}
                                    @endif
                                </a>

                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item my-1" href="{{ route('user#accountChangePage') }}"><i class="fa-solid fa-user"></i> Account</a></li>
                                    <li><a class="dropdown-item my-1" href="{{ route('user#changePasswordPage') }}"><i class="fa-solid fa-key"></i> Change password</a></li>
                                    <li>
